...
public class JavaApplication11 extends JFrame implements ActionListener{  
    JButton b1,b2,b3,b4,b5,b6,b7,b8,b9,next;  
    JavaApplication11(){
        //super("JavaApplication11");  
        b1=new JButton("1");   
        b2=new JButton(" ");  
        b3=new JButton("3");   
        b4=new JButton("4");   
...
//end of constructor    
    public void actionPerformed(ActionEvent e){   
      ...
      { 
          ...
          if(b1.getLabel().equals("1")&&b2.getLabel().equals("2")&&b3.getLabel()   .equals("3")&&b4.getLabel().equals("4")&&b5.getLabel().equals("5")   &&b6.getLabel().equals("6")&&b7.getLabel().equals("7")&&b8.getLabel()   .equals("8")&&b9.getLabel().equals(" ")){    JOptionPane.showMessageDialog(JavaApplication11.this,"!!!you won!!!"); 
          } 
      } 
    } 
